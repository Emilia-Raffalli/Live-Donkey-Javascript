...
console.log(
  fireSigns[fireSigns.length - 1] === "♐" ? "Good Answer ✅"  : "Wrong Answer ❌"
);
...
zodiacSigns =  fireSigns.concat(earthSigns, airSigns, waterSigns);
console.log(`le tableau des signes du Zodiaque complet est le suivant : ${zodiacSigns}.`);

console.log(
  (zodiacSigns !== null && zodiacSigns.toString() === "♈,♌,♐,♉,♍,♑,♋,♏,♓︎,♊,♎,♒") ? "Good Answer ✅"  : "Wrong Answer ❌");
/*  
